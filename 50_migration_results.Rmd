...
```{r migration_chart, fig.width=8, fig.height=8, eval=FALSE} 
query = "
select origin
     , destination
     , count(gsm) as \"count\"
...
```{r migration_chart_solid, fig.width=8, fig.height=8, eval=FALSE} 
query = "
select origin
     , destination
     , count(gsm) as \"count\"
...
```{r migration_chart_wo_blood, fig.width=7, fig.height=7, eval=FALSE}
...
ggplot(data=organism, aes(x=ORGANISM, y=RATIO)) + 
  geom_boxplot() +
